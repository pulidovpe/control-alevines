...
<center>
	<div id="busca-productor">
		<br />
		<h2>Imprimir listado de productores</h2><br />
		<form name="frmbusqueda" action="" onsubmit="javascript:listado(); return false">	
		<table width="42%" border="1" align="center" bordercolor="#F0F0F0">
			...
			<tr>
				<td colspan="2" align="center">
					...
					<input type="button" value="Borrar" onclick="javascript:llamarasincronoget('imprimirproductor.php','contenedor','centro','0');" />
