...
--
DROP DATABASE IF EXISTS `piscicola`;
...
-- Procedimientos
--
DROP PROCEDURE IF EXISTS `productor1`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `productor1`(in cedula1 int(10),in nombres1 varchar(30),in apellidos1 varchar(25),in razons1 varchar(5),in direccion1 varchar(50),in telefono1 varchar(20),in estados1 varchar(15),in municipios1 varchar(25))
BEGIN
INSERT INTO piscicola.productor VALUES (cedula1,nombres1,apellidos1,razons1,direccion1,telefono1,estados1,municipios1);
END$$

DROP PROCEDURE IF EXISTS `proforma1`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `proforma1`(in id_fact1 int(6),in fecha1 date,in ced_prod1 int(10),in compra11 smallint(7),in compra21 smallint(7),in compra31 smallint(7),in compra41 smallint(7),in precio11 float(10.2),in precio21 float(10.2),in precio31 float(10.2),in precio41 float(10.2),in total1 float(10.2))
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `registrarse`(in usuario1 varchar(10),in clave1 varchar(128),in tipo1 tinyint(4),in nombre1 varchar(25),in telefono1 varchar(11))
BEGIN
...
(33, '0000-00-00', 102, 2234484, ''),
(34, '0000-00-00', 103, 3769539, ''),
(35, '0000-00-00', 104, 8168199, ''),
(36, '0000-00-00', 105, 31458130, ''),
(37, '0000-00-00', 106, 11755869, ''),
(38, '0000-00-00', 107, 31549247, ''),
(39, '0000-00-00', 108, 3349462, '');
...
(50, 'Deposito', '0000000000', '2014-04-19', 350, 'TESORO', '01630228722283002826', 102),
(51, 'Deposito', '0000000000', '2014-04-19', 200, 'TESORO', '01630228722283002826', 103),
(52, 'Cheque', '1111111111', '2014-04-19', 150, 'TESORO', '01630228722283002826', 103),
(53, 'Cheque', '2222222222', '2014-04-19', 300, 'TESORO', '01630228722283002826', 104),
(54, 'Cheque', '3333333333', '2014-05-10', 200, 'TESORO', '01630228722283002826', 104),
(55, 'Deposito', '4444444444', '0000-00-00', 180, 'TESORO', '01630228722283002826', 104),
(56, 'Cheque', '2222222222', '2014-04-19', 200, 'TESORO', '01630228722283002826', 105),
(57, 'Deposito', '1111111111', '0000-00-00', 100, 'TESORO', '01630228722283002826', 105),
(58, 'Cheque', '4444444444', '0000-00-00', 50, 'TESORO', '01630228722283002826', 105),
(59, 'Deposito', '0000000000', '2014-04-19', 200, 'TESORO', '01630228722283002826', 106),
(60, 'Cheque', '1111111111', '2014-05-10', 100, 'TESORO', '01630228722283002826', 106),
(61, 'Cheque', '4444444444', '2014-05-10', 50, 'TESORO', '01630228722283002826', 106),
(62, 'Deposito', '0000000000', '2014-04-19', 400, 'TESORO', '01630228722283002826', 106),
(63, 'Cheque', '1111111111', '2014-04-19', 200, 'TESORO', '01630228722283002826', 106),
(64, 'Efectivo', '0000000000', '2014-04-19', 80, 'TESORO', '01630228722283002826', 106),
(65, 'Deposito', '2222222222', '2014-04-19', 300, 'TESORO', '01630228722283002826', 107),
(66, 'Cheque', '1111111111', '2014-05-10', 250, 'TESORO', '01630228722283002826', 107),
(67, 'Efectivo', '0000000000', '2014-04-19', 50, 'TESORO', '01630228722283002826', 107),
(68, 'Deposito', '0000000000', '2014-04-19', 150, 'TESORO', '01630228722283002826', 108),
(69, 'Cheque', '1111111111', '2014-05-10', 400, 'TESORO', '01630228722283002826', 108),
(70, 'Cheque', '4444444444', '2014-04-19', 50, 'TESORO', '01630228722283002826', 108);
...
(102, '2014-04-19', 2234484, 300, 0, 0, 2, 330.00, 0.00, 0.00, 20.00, 0, 350.00),
(103, '2014-04-19', 3769539, 300, 0, 0, 2, 330.00, 0.00, 0.00, 20.00, 0, 350.00),
(104, '2014-04-19', 8168199, 500, 0, 0, 3, 550.00, 0.00, 0.00, 30.00, 100, 680.00),
(105, '2014-04-19', 31458130, 300, 0, 0, 2, 330.00, 0.00, 0.00, 20.00, 0, 350.00),
(106, '2014-04-19', 11755869, 500, 0, 0, 3, 550.00, 0.00, 0.00, 30.00, 100, 680.00),
(107, '2014-04-19', 31549247, 500, 0, 0, 3, 550.00, 0.00, 0.00, 30.00, 20, 600.00),
(108, '2014-04-19', 3349462, 500, 0, 0, 3, 550.00, 0.00, 0.00, 30.00, 20, 600.00);
...
(31000001, 'Productor de prueba', 'Prueba de productor', 'V', '31000031', 'CXCXCXCXCX CXCXCXCX ', 'GuÃ¡rico', 'CamaguÃ¡n'),
...
('usuario002', 'e10adc3949ba59abbe56e057f20f883e', 2, 'Usuario 002', '2111111222'),
...
('usuario888', 'e10adc3949ba59abbe56e057f20f883e', 2, 'USUARIO NUMERO 888', '8888888888'),
('usuario999', '202cb962ac59075b964b07152d234b70', 2, 'Usuario 999', '8888888888'),
('yuna', '81dc9bdb52d04dc20036dbd8313ed055', 2, 'yunaika', '2147483647');

--
-- Disparadores `usuarios`
--
DROP TRIGGER IF EXISTS `nueva_clave`;
DELIMITER //
CREATE TRIGGER `nueva_clave` BEFORE INSERT ON `usuarios`
 FOR EACH ROW BEGIN
SET NEW.clave = MD5(NEW.clave);
END
//
DELIMITER ;
DROP TRIGGER IF EXISTS `cambia_clave`;
DELIMITER //
CREATE TRIGGER `cambia_clave` BEFORE UPDATE ON `usuarios`
 FOR EACH ROW BEGIN
SET NEW.clave = MD5(NEW.clave);
END
//
