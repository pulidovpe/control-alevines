...
//$resultado1 = mysql_query("SELECT auto_increment FROM information_schema.tables WHERE table_name='reposicion' ",$conecta);
//$registros1 = mysql_fetch_array($resultado1);
//$ultima_repo = $registros1['auto_increment'];
$resultado1 = mysql_query("SELECT `id_reposicion` FROM `reposicion` ORDER BY `id_reposicion` DESC LIMIT 1",$conecta);
$registros1 = mysql_fetch_array($resultado1);
$ultima_repo = $registros1['id_reposicion'] + 1;
...
<div id="reposicion">
	<center>
		<h1>Incluir Reposiciones</h1>
	<center>
	<!-- form method="post" action="validarincluirreposicion.php" -->
	<form name="planilla1" id="planilla1" method="post" onsubmit="llamarasincronopost('validarincluirreposicion.php','reposicion','mensaje','6',
		...
		<fieldset>
  			<legend>Reposicion</legend>
			<div align="left">
				<label>Numero de Reposicion:</label>					
				<input type="text" name="id_reposicion" id="id_reposicion" size="5" maxlength="10" disabled="disabled" value="<?php echo $ultima_repo; ?>" />
  			...
  			<table border="0" width="600">
  				<tr>
  					...
  					<td align="right">
  						...
  						<input type="button" name="Cobrar" id="Cobrar" value="Cobrar" onclick="llamarasincronopost('validarincluirdeposito.php','reposicion','mensaje','5',
		...
		<table>
			<tr>
				<td>
					...
					<input type="button" value="Cancelar" onclick="llamarasincronoget('reposiciones.php','contenedor','centro','0')" />
				</td>
			</tr>
		</table>
	</form>
